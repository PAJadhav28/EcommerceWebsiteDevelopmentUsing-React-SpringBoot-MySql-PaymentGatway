...
export default function Product() {
  ...
  const location = useLocation() // for location we need to install react-router-dom
  const navigate = useNavigate();

//   to choose multiple colors and size
  const handleFilter=(value, sectionId)=>{
    const searchParamms = new URLSearchParams(location.search)
    let filterValue = searchParamms.getAll(sectionId)

    // display cloths according to selection of multiple colors
